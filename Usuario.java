...
public class Usuario {
	...
	// METODO DE PEDIR CONTRASEÑA QUE DESAROLLARE EN SETCONTRASENA PARA PODER
	// UTILIZARLO DE NUEVO EN MOMENTO DE CAMBIAR LA CONTRASEÑA.
	...
	// CONTRASEÑA TIENE EN ALGUN LADO AL MENOS UN CARACTER EN MAYUSCULA, EN ALGUN
	// LADO AL MENOS UN NUMERO, EN ALGUN PARTE UN SIGNO RARO, Y AL MENOS 8
	// CARACTERES, POSTERIORMENTE CREO UN BUCLE QUE SI NO SE CUMPLE O ESTA REPETIDA,
	// EN LAS TRES ANTERIORES CONTRASEÑAS VALIDAS, VOLVERA A PEDIR UNA Y OTRA VEZ
	...
	// ENCUENTRA QUE ESTA IGUAL DEVOLVERA FALLO DE OPERACION.
	...
	// OTRAS PERDIENDO SIEMPRE LA TERCERA EN CASO DE QUE HUBIERA CAMBIADO Y LLEGADO
	// A 4 CONTRASEÑAS EN LA APP.
